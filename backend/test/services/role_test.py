...
from .permission_data import ambassador_checkin_create_permission
...
def test_details(role_svc: RoleService):
    ...
    assert ambassador_checkin_create_permission in details.permissions
...
def test_revoke_permission(
    ...
    role_svc.revoke_permission(
        root, ambassador_role.id, ambassador_checkin_create_permission.id
    )
