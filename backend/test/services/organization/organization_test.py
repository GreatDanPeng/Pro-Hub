...
__authors__ = ["Dan Peng, Ajay Gandecha"]
...
def get_status_by_slug(organization_svc_integration: OrganizationService):
    """Test that organizations can be retrieved based on their slug."""
    organization = organization_svc_integration.get_by_slug(cads.slug)
    assert organization is not None
    assert organization.slug == cads.slug
    assert organization.public == "request"
