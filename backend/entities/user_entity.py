...
class UserEntity(EntityBase):
    ...
    # All of the organizations that the user is a part of.
    # NOTE: This field establishes a many-to-many relationship between the users and organizations table.
    #       and uses the "user_organization" table as the join table.
    organizations: Mapped[list["OrganizationEntity"]] = relationship(
        secondary=user_organization_table, back_populates="users"
    )
